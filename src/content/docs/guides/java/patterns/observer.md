...
description: Java Observer Pattern (BEHAVIORAL PATTERN)
sidebar:
  order: 6
---

_Java Observer Pattern (BEHAVIORAL PATTERN)_

_Publish-Subscribe pattern_

**Observer Pattern**: **Publish-Subscribe** model where objects automatically get notified of state changes - like YouTube notifications for new videos!
